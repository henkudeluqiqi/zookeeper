...
public class ZooKeeper {
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher)
        ...
        // connectString Zookeeper连接的地址，多个地址,分隔
        // sessionTimeout Zookeeper会话的默认超时时间
        // watcher监听对象
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher,
        ...
        // 对我们传入进来的Zookeeper连接地址进行了解析
        ConnectStringParser connectStringParser = new ConnectStringParser(
                connectString);
        /**
         * connectStringParser.getServerAddresses() 将会获取到我们配置的所有Zookeeper解析后的对象
         * 里面包含了Zookeeper的连接地址和端口号
         * 这里也只是对我们的连接地址进行了一些管理 ， 打乱了连接地址的顺序
         */
    ...
    public String create(final String path, byte data[], List<ACL> acl,
        ...
        // 提交后判断本次的状态 如果不等于0的话说明本次请求出现了问题 那么就直接抛出异常
        if (r.getErr() != 0) {
    ...
    private static ClientCnxnSocket getClientCnxnSocket() throws IOException {
        ...
        // 尝试去系统属性中获取 ZOOKEEPER_CLIENT_CNXN_SOCKET = "zookeeper.clientCnxnSocket"; 数据
        String clientCnxnSocketName = System
                .getProperty(ZOOKEEPER_CLIENT_CNXN_SOCKET);
        if (clientCnxnSocketName == null) {
            // 如果没有获取到 那么底层默认使用NIO进行网络数据的传输
